...
+ (UIColor*)colorOfNavigationBar{
    return [UIColor colorWithRed:31/255.0f green:31/255.0f blue:31/255.0f alpha:1.0];
}
//Color of background view in navigation bar, only for iOS 7 for transparency
+ (UIColor*)colorOfBackgroundNavBarImage {
    return [UIColor colorWithRed:31/255.0f green:31/255.0f blue:31/255.0f alpha:0.7];
}
...
+ (UIColor*)colorOfLoginText {
    return [UIColor colorWithRed:25/255.0f green:22/255.0f blue:152/255.0f alpha:1.0];
}
...
+ (UIColor*)colorOfLoginTopBackground {
    return [UIColor colorWithRed:31/255.0f green:31/255.0f blue:31/255.0f alpha:1];
}
